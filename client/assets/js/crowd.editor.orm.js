var CrowdEditorOrm = {
  ...
  initPalette: function (crowd) {
    ...
    crowd.palette.initORMShapes = function () {
      ...
      const original_strokeFill_constraint =
        crowd.palette.colors.constraintStroke;
      ...
      joint.dia.Element.define(
        ...
        {
          markup:
            '<g class="rotatable"><g class="scalable"><ellipse class="external_ellipse"/><ellipse class="internal_ellipse"/></g><text/></g>',
        }
      );
      ...
      joint.dia.Element.define(
        ...
        {
          markup:
            '<g class="rotatable"><g class="scalable"><ellipse class="external_ellipse"/><line class="line1"/><line class="line2"/></g><text/></g>',
        }
      );

      //define orm exclusive exhaustive constraint shape in joint
      joint.dia.Element.define(
        "orm.ExclusiveExhaustive",
        {
          size: {
            width: 30,
            height: 30,
        ...
        {
          markup:
            '<g class="rotatable"><g class="scalable"><ellipse class="external_ellipse"/><ellipse class="internal_ellipse"/><line class="line1"/><line class="line2"/></g><text/></g>',
        }
      );
      ...
      joint.dia.Element.define(
        ...
        {
          markup:
            '<g class="rotatable"><g class="scalable"><ellipse class="external_ellipse"/><text class="simb"/><line class="line2"/></g><text/></g>',
        }
      );
    ...
    crowd.palette.elements.entityReferenceMode =
      new joint.shapes.orm.EntityReferenceMode({
        parentType: "entity",
    ...
    crowd.palette.elements.value = new joint.shapes.orm.Value({
      ...
      name: "Value",
      datatype: "string",
      uri: crowd.config.defaultNamespace + "#value",
    });
    ...
    //   name: 'Role',
    //   read: 'right',
    //   uri: crowd.config.defaultNamespace + '#fact-type'
    // });
    ...
    crowd.palette.elements.roleBinary = new joint.shapes.orm.RoleBinary({
      ...
      roles: {
        left: crowd.config.defaultNamespace + "#role-a",
        right: crowd.config.defaultNamespace + "#role-b",
      },
      uri: crowd.config.defaultNamespace + "#fact-type",
    ...
    crowd.palette.elements.exclusiveExhaustive =
      new joint.shapes.orm.ExclusiveExhaustive({
        parentType: "constraint",
  ...
  initElementsToolsViews: function (crowd) {
    ...
    var linkInheritanceTool = function (config) {
      ...
      return crowd.workspace.tools.elements.linkTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to connect the object with a <b class="crowd-bold-color">subtype</b> connector',
            placement: "top",
          },
        }),
      });
    ...
    crowd.workspace.tools.elements.elementsToolsView["entityReferenceMode"] =
      new joint.dia.ToolsView({
    ...
    crowd.workspace.tools.elements.elementsToolsView["value"] =
      new joint.dia.ToolsView({
        name: "value-tools",
        tools: crowd.workspace.tools.elements.basicTools.concat([
          linkTool(),
    ...
    crowd.workspace.tools.elements.elementsToolsView["roleUnary"] =
      new joint.dia.ToolsView({
    ...
    crowd.workspace.tools.elements.elementsToolsView["roleBinary"] =
      new joint.dia.ToolsView({
        ...
        tools: crowd.workspace.tools.elements.basicTools.concat([
          linkTool({
            ...
            placement: "left",
            title:
              'Click and drag to connect the object with a connector from <b class="crowd-bold-color">left</b>',
          }),
          linkTool({
            port: "right",
            magnet: "relRight",
            ...
            placement: "right",
            title:
              'Click and drag to connect the object with a connector from <b class="crowd-bold-color">right</b>',
          }),
        ]),
      });

    //create tools view for constraint union
    crowd.workspace.tools.elements.elementsToolsView["union"] =
      new joint.dia.ToolsView({
        name: "union-tools",
        tools: crowd.workspace.tools.elements.basicTools.concat([
          linkTool({
            type: "constraintConnector",
            title:
              'Click and drag to connect the object with a <b class="crowd-bold-color">constraint</b> connector',
          }),
        ]),
      });

    //create tools view for constraint exclusive
    crowd.workspace.tools.elements.elementsToolsView["exclusive"] =
      new joint.dia.ToolsView({
    ...
    crowd.workspace.tools.elements.elementsToolsView["exclusiveExhaustive"] =
      new joint.dia.ToolsView({
    ...
    crowd.workspace.tools.elements.elementsToolsView["subset"] =
      new joint.dia.ToolsView({
        name: "subset-tools",
        tools: crowd.workspace.tools.elements.basicTools.concat([
          linkTool({
          ...
          linkTool({
            ...
            offset: { x: 25, y: 10 },
            title:
              'Click and drag to connect the object with a <b class="crowd-bold-color">constraint</b> connector directioned',
          }),
        ]),
      });

    //create tools view for constraint equality
    crowd.workspace.tools.elements.elementsToolsView["equality"] =
      new joint.dia.ToolsView({
        name: "equality-tools",
        tools: crowd.workspace.tools.elements.basicTools.concat([
          linkTool({
  ...
  initChangeAttributesEvents: function (crowd) {
    ...
    crowd.workspace.graph.on("change:type", function (element, newType) {
      ...
      if (element.isElement()) {
        ...
        element.attributes.label =
          crowd.palette.elements[newType].attributes.label;
    ...
    crowd.workspace.graph.on("change:refUri", function (element, newRefUri) {
      ...
      if (
        ...
        var refUriText = fromURI(newRefUri, crowd.config.defaultNamespace);
        element.attr(
          "refMode/text",
          joint.util.breakText(
            "(" + (refUriText ? refUriText : "ref. mode") + ")",
            { width: element.attributes.size.width }
          )
        );
        // element.attr('text/text', fromURI(newRefUri, crowd.config.defaultNamespace));
        // element.attributes.name = fromURI(newRefUri, crowd.config.defaultNamespace);
        // $('#crowd-inspector-content--name--' + crowd.id).val(element.attributes.name);
      }
    });
    ...
    crowd.workspace.graph.on(
      "change:cardinality",
      function (element, newCardinality) {
        // console.log('change:cardinality', { element, newCardinality });

        if (
          element.isElement() &&
          element.attributes.parentType == "role" &&
          newCardinality
        ) {
          //change uniqueness lines
          if (
            !crowd.orm.uniqOne(newCardinality.left) &&
            !crowd.orm.uniqOne(newCardinality.right)
          ) {
            ...
            element.attr(
              "uniqueLeft/display",
              crowd.orm.uniqOne(newCardinality.left) ? "unset" : "none"
            );
            element.attr(
              "uniqueRight/display",
              crowd.orm.uniqOne(newCardinality.right) ? "unset" : "none"
            );
          ...
          var hasFreqLeft =
            !crowd.orm.uniqOne(newCardinality.left) &&
            !crowd.orm.uniqMany(newCardinality.left);
          element.attr(
            "frequencyLeftLabel/text",
            crowd.orm.convertFrequency(newCardinality.left)
          );
          element.attr(
            "frequencyLeftLabel/display",
            hasFreqLeft ? "unset" : "none"
          );
          element.attr(
            "frequencyLeftLabelBackground/display",
            hasFreqLeft ? "unset" : "none"
          );
          element.attr(
            "frequencyLeftLine/display",
            hasFreqLeft ? "unset" : "none"
          );

          var hasFreqRight =
            !crowd.orm.uniqOne(newCardinality.right) &&
            !crowd.orm.uniqMany(newCardinality.right);
          element.attr(
            "frequencyRightLabel/text",
            crowd.orm.convertFrequency(newCardinality.right)
          );
          element.attr(
            "frequencyRightLabel/display",
            hasFreqRight ? "unset" : "none"
          );
          element.attr(
            "frequencyRightLabelBackground/display",
            hasFreqRight ? "unset" : "none"
          );
          element.attr(
            "frequencyRightLine/display",
            hasFreqRight ? "unset" : "none"
          );
              ...
              if (link.attributes.type == "connector") {
                if (
                  (link.attributes.source?.id == element.id &&
                    link.attributes.source?.port == "left") ||
                  (link.attributes.target?.id == element.id &&
                    link.attributes.target?.port == "left")
                ) {
                  // if (!hasFreqLeft)
                  link.prop(
                    "mandatory",
                    newCardinality.left.split("..")[0] != "0"
                  );
                }

                if (
                  (link.attributes.source?.id == element.id &&
                    link.attributes.source?.port == "right") ||
                  (link.attributes.target?.id == element.id &&
                    link.attributes.target?.port == "right")
                ) {
                  // if (!hasFreqRight)
                  link.prop(
                    "mandatory",
                    newCardinality.right.split("..")[0] != "0"
                  );
                }
              }
            });
    ...
    crowd.workspace.graph.on("change:type", function (link, newType) {
      ...
      if (link.isLink()) {
        ...
        link.attributes.attrs = $.extend(
          true,
          {},
          crowd.palette.links[newType].attributes.attrs
        );
        ...
        if (
          newType != "connector" &&
          newType != "constraintConnector" &&
          (!link.prop("direction") || link.prop("direction") == "null")
        )
          link.attributes.direction = "target";
        else if (newType == "connector") link.attributes.direction = null;
        link.trigger("change:direction", link, link.prop("direction"));

        if (
          newType == "inheritanceConnector" ||
          newType == "constraintConnector"
        ) {
      ...
      if (link.isLink()) {
        ...
        if (link.attributes.type == "connector") {
          if (linkSourceType == "entity") {
            link.attributes.attrs.line.sourceMarker = $.extend(
              true,
              {},
              crowd.palette.links[link.attributes.type].attributes.attrs.line
                .sourceMarker
            );
            // link.attributes.attrs.line.targetMarker = {};
            link.attributes.attrs.line.sourceMarker.display = newMandatory
              ? "unset"
              : "none";
            link.attributes.attrs.line.targetMarker.display = "none";
          } else {
            link.attributes.attrs.line.targetMarker = $.extend(
              true,
              {},
              crowd.palette.links[link.attributes.type].attributes.attrs.line
                .targetMarker
            ...
            link.attributes.attrs.line.targetMarker.display = newMandatory
              ? "unset"
              : "none";
          }
          ...
          if (sourceElem?.attributes?.type == "roleBinary") {
            let newCard = sourceElem.prop(
              "cardinality/" + link.attributes.source.port
            );
            if (newCard) {
              let hasFreq =
                !crowd.orm.uniqOne(newCard) && !crowd.orm.uniqMany(newCard);
              // if (!hasFreq) {
              newCard =
                (newMandatory
                  ? hasFreq && newCard.split("..")[0] != "0"
                    ? newCard.split("..")[0]
                    : "1"
                  : "0") +
                ".." +
          ...
          if (targetElem?.attributes?.type == "roleBinary") {
            let newCard = targetElem.prop(
              "cardinality/" + link.attributes.target.port
            );
            if (newCard) {
              let hasFreq =
                !crowd.orm.uniqOne(newCard) && !crowd.orm.uniqMany(newCard);
    ...
    crowd.workspace.graph.on("change:semantic", function (cell, newSemantic) {
      ...
      if (cell.isElement()) {
        ...
        if (cell.attributes.type == "roleUnary")
          colorMarkups = ["relLeft/stroke"];
        else if (cell.attributes.type == "roleBinary")
          colorMarkups = [
            "relLeft/stroke",
            "relCenter/stroke",
            "relRight/stroke",
        ...
        colorMarkups.forEach(function (colorMarkup) {
          color =
            unsatisfiable != null || inferred != null
              ? color
              : crowd.palette.elements[cell.attributes.type]?.attr(colorMarkup);
    ...
    switch (crowd.inspector.model.attributes.type) {
      case "entityReferenceMode":
        crowd.inspector.addAttribute({
          ...
          property: "refUri",
          type: "uri",
          default: crowd.config.defaultNamespace + "#ref-entity",
        });
        break;
    }
          ...
          parameters: [
            {
              ...
              property: "left",
              type: "text",
              placeholder: "Left Cardinality",
            },
            {
              label: "Right",
              property: "right",
              type: "text",
              placeholder: "Right Cardinality",
            },
          ],
        });
        crowd.inspector.addAttribute({
  ...
  toJSONSchema: function (crowd) {
    ...
    var rolePortMap = {
      left: crowd.config.defaultNamespace + "#left",
      right: crowd.config.defaultNamespace + "#right",
      center: crowd.config.defaultNamespace + "#center",
    };
      ...
      switch (element.attributes.parentType) {
        case "entity":
          ...
          crowd.workspace.graph
            ...
            .forEach(function (link) {
              if (
                link.attributes.type == "inheritanceConnector" &&
                ...
                var childEntity;
                if (
                  link.attributes.direction == "source" &&
                  link.attributes.source.id == element.attributes.id
                ) {
                  parentEntity = link.getSourceElement();
                  childEntity = link.getTargetElement();
                } else if (
                  link.attributes.direction == "target" &&
                  link.attributes.target.id == element.attributes.id
                ) {
                ...
                if (parentEntity && childEntity) {
                  ...
                  crowd.workspace.graph
                    ...
                    .forEach(function (inheritanceLink) {
                      if (
                        inheritanceLink.attributes.type == "constraintConnector"
                      ) {
                        var connectedConstraint;
                        if (
                          inheritanceLink.attributes.source.id != link.id &&
                          inheritanceLink.getSourceElement()?.attributes
                            .parentType == "constraint"
                        ) {
                          connectedConstraint =
                            inheritanceLink.getSourceElement();
                        } else if (
                          inheritanceLink.attributes.target.id != link.id &&
                          inheritanceLink.getTargetElement()?.attributes
                            .parentType == "constraint"
                        ) {
                          connectedConstraint =
                            inheritanceLink.getTargetElement();
                        }
                  ...
                  if (connectedConstraints.length) {
                    connectedConstraints.forEach(function (constraint) {
                      var existentInheritance = jsonSchema.connectors.find(
                        function (connector) {
                          return (
                            connector.type == "subtyping" &&
                            connector.parent == parentEntity.attributes.uri &&
                            connector.subtypingContraint.includes(constraint.id)
                          );
                        }
                      );
                      ...
                      if (!existentInheritance) {
                        ...
                        existentInheritance.entities.push(
                          childEntity.attributes.uri
                        );
                      }
                    });
                  } else {
                    //case that's only inheritance
                    var existentInheritance = jsonSchema.connectors.find(
                      function (connector) {
                        return (
                          connector.type == "subtyping" &&
                          connector.parent == parentEntity.attributes.uri &&
                          connector.subtypingContraint.length <= 0
                        );
                      }
                    );
              ...
              if (link.attributes.type == "connector") {
                ...
                if (connectedEntity && port) {
                  if (element.attributes.type == "roleUnary") {
                    ...
                    if (link.attributes.mandatory)
                      role.mandatory.push(connectedEntity.attributes.uri);
                    ...
                    if (port == "left") {
                      ...
                      if (link.attributes.mandatory)
                        role.mandatory.unshift(connectedEntity.attributes.uri);
                      role.uniquenessConstraints.unshift(
                        element.attributes.cardinality[port]
                      );
                      ...
                      if (link.attributes.mandatory)
                        role.mandatory.push(connectedEntity.attributes.uri);
                      role.uniquenessConstraints.push(
                        element.attributes.cardinality[port]
                      );
        ...
        case "constraint":
          var constraint = {
            ...
            factTypes: [],
            ...(element.attributes.type == "subset"
              ? { factParentPosition: [] }
              : {}),
            factPosition: [],
            type: "roleConstraint",
          ...
          crowd.workspace.graph
            ...
            .forEach(function (link) {
              if (link.attributes.type == "constraintConnector") {
                ...
                if (
                  link.attributes.source.id != element.id &&
                  link.getSourceElement()?.attributes.parentType == "role"
                ) {
                  connectedRole = link.getSourceElement();
                  port = link.attributes.source.port;
                } else if (
                  link.attributes.target.id != element.id &&
                  link.getTargetElement()?.attributes.parentType == "role"
                ) {
          ...
          if (constraint.factTypes.length)
            jsonSchema.connectors.push(constraint);
          break;
      }
    });
      ...
      if (connector.type == "subtyping") {
        jsonSchema.connectors.forEach(function (otherConnector, ocIndex) {
          ...
          if (
            ...
            connector.subtypingContraint = connector.subtypingContraint.concat(
              otherConnector.subtypingContraint
            );
      ...
      if (connector.type == "subtyping") {
        ...
        connector.subtypingContraint.forEach(function (constraintId) {
          typedConstraints = [
            ...new Set([
              ...typedConstraints,
              ...constraintTypeInheritanceMap[
                crowd.workspace.graph.getCell(constraintId).attributes.type
              ],
            ]),
          ];
        });
  ...
  fromJSONSchema: function (crowd, schema) {
    ...
    var constraintTypeInheritanceMap = function (constraints) {
      ...
      if (
        constraints.find((e) => e == "exclusive") &&
        constraints.find((e) => e == "union")
      ) {
        constraintsResult.push("exclusiveExhaustive");
        constraintsResult = constraintsResult.filter(
          (e) => e != "exclusive" && e != "union"
        );
      }
    ...
    if (schema) {
      ...
      if (schema.entities) {
        schema.entities.forEach(function (entity) {
          entitiesObj[entity.name] =
            crowd.palette.elements[entityTypeMap[entity.type]].clone();
      ...
      if (schema.relationships) {
        schema.relationships.forEach(function (relationship) {
          ...
          rolesObj[relationship.name] =
            crowd.palette.elements[
              isBinary ? "roleBinary" : "roleUnary"
            ].clone();
          crowd.workspace.graph.addCell(rolesObj[relationship.name]);

          relationship.entities.forEach(function (entity, index) {
            linksObj[relationship.name + "#" + entity] =
              crowd.palette.links.connector.clone();
            linksObj[relationship.name + "#" + entity].source({
              id: rolesObj[relationship.name].id,
              port: index == 0 ? "left" : "right",
              magnet: index == 0 ? "relLeft" : "relRight",
            });
            linksObj[relationship.name + "#" + entity].target(
              entitiesObj[entity]
            );
            crowd.workspace.graph.addCell(
              linksObj[relationship.name + "#" + entity]
            );
            linksObj[relationship.name + "#" + entity].prop(
              "mandatory",
              relationship.mandatory.includes(entity)
            );
          ...
          $.each(relationship, function (attribute, value) {
            switch (attribute) {
              case "name":
                rolesObj[relationship.name].prop(
                  "uri",
                  isURI(value)
                    ? value
                    : crowd.config.defaultNamespace + "#" + value
                );
                break;
              case "inverseReading":
                rolesObj[relationship.name].prop(
              ...
              case "uniquenessConstraints":
                if (isBinary) {
                  rolesObj[relationship.name].prop(
                    "cardinality/left",
                    cardinalityMap(value[0])
                  );
                  rolesObj[relationship.name].prop(
                    "cardinality/right",
                    cardinalityMap(value[1])
                  );
                }
                break;
              case "roles":
          ...
          if (connector.type == "subtyping") {
            connector.entities.forEach(function (entity) {
              if (!linksObj[connector.parent + "#" + entity]) {
                linksObj[connector.parent + "#" + entity] =
                  crowd.palette.links.inheritanceConnector.clone();
                linksObj[connector.parent + "#" + entity].prop(
                  "uri",
                  connector.name
                );
                linksObj[connector.parent + "#" + entity].source(
                  entitiesObj[entity]
                );
                linksObj[connector.parent + "#" + entity].target(
                  entitiesObj[connector.parent]
                );
                crowd.workspace.graph.addCell(
                  linksObj[connector.parent + "#" + entity]
                );
            ...
            constraintTypeInheritanceMap(connector.subtypingContraint).forEach(
              function (constraint) {
                // console.log('inherConstraint', constraint);
                constraintsObj[connector.name + "#" + constraint] =
                  crowd.palette.elements[constraint].clone();
                crowd.workspace.graph.addCell(
                  constraintsObj[connector.name + "#" + constraint]
                );
                connector.entities.forEach(function (entity) {
                  linksObj[connector.name + "#" + entity + "#" + constraint] =
                    crowd.palette.links.constraintConnector.clone();
                  linksObj[
                    connector.name + "#" + entity + "#" + constraint
                  ].source(constraintsObj[connector.name + "#" + constraint]);
                  linksObj[
                    connector.name + "#" + entity + "#" + constraint
                  ].target(linksObj[connector.parent + "#" + entity]);
                  crowd.workspace.graph.addCell(
                    linksObj[connector.name + "#" + entity + "#" + constraint]
                  );
                  linksObj[
                ...
                constraintsObj[connector.name + "#" + constraint]?.position(
                  mediumPosition.x,
                  mediumPosition.y
                );
              }
            ...
            constraintsObj[connector.name] =
              crowd.palette.elements[connector.roleConstraint].clone();
            ...
            connector.factTypes.forEach(function (factType, index) {
              linksObj[connector.name + "#" + factType] =
                crowd.palette.links.constraintConnector.clone();
              linksObj[connector.name + "#" + factType].source(
                constraintsObj[connector.name]
              );
              linksObj[connector.name + "#" + factType].target({
                id: rolesObj[factType].id,
                port: rolePortMap(connector.factPosition[index]),
                magnet:
                  "rel" +
                  capitalize(rolePortMap(connector.factPosition[index])),
              });
              crowd.workspace.graph.addCell(
                linksObj[connector.name + "#" + factType]
              );
            ...
            connector.factParent?.forEach(function (factParent, index) {
              linksObj[connector.name + "#" + factParent] =
                crowd.palette.links.constraintConnector.clone();
              linksObj[connector.name + "#" + factParent].source(
                constraintsObj[connector.name]
              );
              linksObj[connector.name + "#" + factParent].target({
                id: rolesObj[factParent].id,
                port: rolePortMap(connector.factParentPosition[index]),
                magnet:
                  "rel" +
                  capitalize(rolePortMap(connector.factParentPosition[index])),
              });
              crowd.workspace.graph.addCell(
                linksObj[connector.name + "#" + factParent]
              );
              linksObj[connector.name + "#" + factParent].prop(
                "direction",
                "target"
              );
