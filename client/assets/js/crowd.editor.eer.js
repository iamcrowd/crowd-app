var CrowdEditorEer = {
  ...
  initPalette: function (crowd) {
    ...
    crowd.palette.elements.weakEntity = new joint.shapes.erd.Entity({
      ...
      type: "weakEntity",
      name: "Weak\nEntity",
      uri: crowd.config.defaultNamespace + "#weak-entity",
      attrs: {
        text: {
          text: "Weak\nEntity",
          fill: "#000000",
    ...
    crowd.palette.elements.weakRelationship = new joint.shapes.erd.Relationship(
      {
        ...
        name: "Weak\nRelationship",
        uri: crowd.config.defaultNamespace + "#weak-relationship",
        attrs: {
          text: {
            text: "Weak\nRelationship",
            fill: "#000000",
    ...
    crowd.palette.elements.weakKeyAttribute = new joint.shapes.erd.Attribute({
      ...
      name: "Weak Key\nAttribute",
      uri: crowd.config.defaultNamespace + "#weak-key-attribute",
      datatype: "string",
      attrs: {
        text: {
          fill: "#000000",
    ...
    crowd.palette.elements.multivaluedAttribute =
      new joint.shapes.erd.Attribute({
        parentType: "attribute",
        type: "multivaluedAttribute",
        name: "Multivalued\nAttribute",
        uri: crowd.config.defaultNamespace + "#multivalued-attribute",
        datatype: "string",
        attrs: {
          text: {
            fill: "#000000",
    ...
    crowd.palette.elements.derivedAttribute = new joint.shapes.erd.Attribute({
      ...
      name: "Derived\nAttribute",
      uri: crowd.config.defaultNamespace + "#derived-attribute",
      datatype: "string",
      attrs: {
        text: {
          fill: "#000000",
  ...
  initElementsToolsViews: function (crowd) {
    ...
    var linkWeakEntityTool = function (config) {
      ...
      return crowd.workspace.tools.elements.linkElementTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to make a <b class="crowd-bold-color">weak entity</b> and connect with it',
            placement: "left",
          },
        }),
        link: {
    ...
    var linkWeakRelationshipTool = function (config) {
      ...
      return crowd.workspace.tools.elements.linkElementTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to make a <b class="crowd-bold-color">weak relationship</b> and connect with it',
            placement: "left",
          },
        }),
        link: {
    ...
    var linkMultivaluedAttributeTool =
      crowd.workspace.tools.elements.linkElementTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to make a <b class="crowd-bold-color">multivalued attribute</b> and connect with it',
            placement: "bottom",
          },
        }),
        link: {
    ...
    var linkWeakKeyAttributeTool =
      crowd.workspace.tools.elements.linkElementTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to make a <b class="crowd-bold-color">weak key attribute</b> and connect with it',
            placement: "top",
          },
        }),
        link: {
    ...
    crowd.workspace.tools.elements.elementsToolsView["weakEntity"] =
      new joint.dia.ToolsView({
    ...
    crowd.workspace.tools.elements.elementsToolsView["weakRelationship"] =
      new joint.dia.ToolsView({
    ...
    crowd.workspace.tools.elements.elementsToolsView["weakKeyAttribute"] =
      new joint.dia.ToolsView({
    ...
    crowd.workspace.tools.elements.elementsToolsView["multivaluedAttribute"] =
      new joint.dia.ToolsView({
    ...
    crowd.workspace.tools.elements.elementsToolsView["derivedAttribute"] =
      new joint.dia.ToolsView({
    ...
    switch (crowd.inspector.model.attributes.type) {
      ...
      case "weakEntity":
        crowd.inspector.addAttribute({
          ...
          property: "type",
          type: "boolean",
          map: { true: "weakEntity", false: "entity" },
        });
        break;
    }
    ...
    switch (crowd.inspector.model.attributes.type) {
      ...
      case "weakRelationship":
        crowd.inspector.addAttribute({
          ...
          property: "type",
          type: "boolean",
          map: { true: "weakRelationship", false: "relationship" },
        });
        break;
    }
        ...
        schema.entities.forEach(function (entity) {
          entitiesObj[entity.name] =
            crowd.palette.elements[
              entity.isWeak ? "weakEntity" : "entity"
            ].clone();
      ...
      if (schema.attributes) {
        schema.attributes.forEach(function (attribute) {
          attributesObj[attribute.name] =
            crowd.palette.elements[attributeTypeMap[attribute.type]].clone();
          ...
          switch (link.type) {
            case "relationship":
              relationshipsObj[link.name] =
                crowd.palette.elements[
                  link.isWeak ? "weakRelationship" : "relationship"
                ].clone();
