var CrowdEditorUml = {
  ...
  initPalette: function (crowd) {
    ...
    crowd.palette.elements.class = new joint.shapes.uml.Class({
      ...
      type: "class",
      name: "Class",
      uri: crowd.config.defaultNamespace + "#class",
      properties: {
        attributes: [],
        methods: [],
      },
      ...
      uncollapsedMarkup:
        '<g class="rotatable"><g class="scalable"><rect class="uml-class-name-rect"/><rect class="uml-class-attrs-rect"/><rect class="uml-class-methods-rect"/></g><text class="uml-class-name-text"/><text class="uml-class-attrs-text"/><text class="uml-class-methods-text"/></g>',
      collapsedMarkup:
        '<g class="rotatable"><g class="scalable"><rect class="uml-class-name-rect"/></g><text class="uml-class-name-text"/></g>',
    });
    ...
    crowd.palette.elements.abstract = new joint.shapes.uml.Abstract({
      ...
      type: "abstract",
      name: "Abstract",
      uri: crowd.config.defaultNamespace + "#abstract",
      properties: {
        attributes: [],
        methods: [],
      },
    ...
    crowd.palette.elements.interface = new joint.shapes.uml.Interface({
      ...
      type: "interface",
      name: "Interface",
      uri: crowd.config.defaultNamespace + "#interface",
      properties: {
        attributes: [],
        methods: [],
      },
    ...
    crowd.palette.links.association = new joint.shapes.standard.Link({
      ...
      roles: {
        source: crowd.config.defaultNamespace + "#role-a",
        target: crowd.config.defaultNamespace + "#role-b",
      },
      direction: "target",
      uri: crowd.config.defaultNamespace + "#association",
    ...
    crowd.palette.links.aggregation = new joint.shapes.standard.Link({
      ...
      direction: "target",
      uri: crowd.config.defaultNamespace + "#aggregation",
      enumerate: ["roles/source", "roles/target"],
      attrs: {
        line: {
          stroke: "black",
    ...
    crowd.palette.links.composition = new joint.shapes.standard.Link({
      ...
      direction: "target",
      uri: crowd.config.defaultNamespace + "#composition",
      enumerate: ["roles/source", "roles/target"],
      attrs: {
        line: {
          stroke: "black",
    ...
    crowd.palette.links.generalization = new joint.shapes.standard.Link({
      ...
      inheritChild: false,
      direction: "target",
      uri: crowd.config.defaultNamespace + "#generalization",
      enumerate: ["roles/source", "roles/target"],
      attrs: {
        line: {
          stroke: crowd.palette.colors.inheritanceStroke,
    ...
    crowd.palette.links.implementation = new joint.shapes.standard.Link({
      ...
      inheritChild: false,
      direction: "target",
      uri: crowd.config.defaultNamespace + "#implementation",
      enumerate: ["roles/source", "roles/target"],
      attrs: {
        line: {
          stroke: crowd.palette.colors.inheritanceStroke,
  ...
  initElementsToolsViews: function (crowd) {
    ...
    var linkAssociationTool = crowd.workspace.tools.elements.linkTool({
      ...
      markup: crowd.workspace.tools.elements.markup({
        ...
        tooltip: {
          title:
            'Click and drag to connect the object with an <b class="crowd-bold-color">association</b>',
          placement: "right",
        },
      }),
    });
    ...
    var linkAggregationTool = crowd.workspace.tools.elements.linkTool({
      ...
      markup: crowd.workspace.tools.elements.markup({
        ...
        tooltip: {
          title:
            'Click and drag to connect the object with an <b class="crowd-bold-color">aggregation</b>',
          placement: "top",
        },
      }),
    });
    ...
    var linkCompositionTool = crowd.workspace.tools.elements.linkTool({
      ...
      markup: crowd.workspace.tools.elements.markup({
        ...
        tooltip: {
          title:
            'Click and drag to connect the object with a <b class="crowd-bold-color">composition</b>',
          placement: "right",
        },
      }),
    });
      ...
      return crowd.workspace.tools.elements.linkTool({
        link: {
          ...
          props: {
            ...
            inheritChild:
              config.inheritChild != null ? config.inheritChild : false,
          },
        },
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to connect the object with a <b class="crowd-bold-color">generalization</b>' +
              (config.inheritChild ? " child" : " parent"),
            placement: "top",
          },
        }),
      });
    ...
    var linkImplementationTool = crowd.workspace.tools.elements.linkTool({
      ...
      markup: crowd.workspace.tools.elements.markup({
        ...
        tooltip: {
          title:
            'Click and drag to connect the object with a <b class="crowd-bold-color">implementation</b>',
          placement: "top",
        },
      }),
    });
    ...
    var linkClassTool = function (config) {
      ...
      return crowd.workspace.tools.elements.linkElementTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to make a <b class="crowd-bold-color">class</b> and connect with it',
            placement: "right",
          },
        }),
        link: {
    ...
    var linkAbstractTool = function (config) {
      ...
      return crowd.workspace.tools.elements.linkElementTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to make an <b class="crowd-bold-color">abstract</b> and connect with it',
            placement: "bottom",
          },
        }),
        link: {
    ...
    var linkInterfaceTool = function (config) {
      ...
      return crowd.workspace.tools.elements.linkElementTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to make a <b class="crowd-bold-color">interface</b> and connect with it',
            placement: "left",
          },
        }),
        link: {
      ...
      return crowd.workspace.tools.elements.linkElementTool({
        ...
        link: {
          ...
          props: {
            ...
            direction: config.direction,
            inheritChild:
              config.inheritChild != null ? config.inheritChild : true,
          },
        },
      });
    };
    ...
    crowd.workspace.tools.elements.elementsToolsView["class"] =
      new joint.dia.ToolsView({
        ...
        tools: crowd.workspace.tools.elements.basicTools.concat([
          ...
          linkAbstractTool({
            type: "generalization",
            cardinality: { source: null, target: null },
            direction: "target",
          }),
          linkInterfaceTool({
            type: "implementation",
    ...
    crowd.workspace.tools.elements.elementsToolsView["abstract"] =
      new joint.dia.ToolsView({
        name: "abstract-tools",
        tools: crowd.workspace.tools.elements.basicTools.concat([
          linkAssociationTool,
    ...
    crowd.workspace.tools.elements.elementsToolsView["interface"] =
      new joint.dia.ToolsView({
    ...
    var linkGeneralizationTool = function () {
      return crowd.workspace.tools.links.linkTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to connect the link with a <b class="crowd-bold-color">generalization</b> parent',
            placement: "top",
          },
          attributes: {
    ...
    var linkRoleSourceGeneralizationTool = function () {
      return crowd.workspace.tools.links.linkRoleTool({
        ...
        markup: crowd.workspace.tools.elements.markup({
          ...
          tooltip: {
            title:
              'Click and drag to connect the link role with a <b class="crowd-bold-color">generalization</b> parent',
            placement: "top",
          },
          attributes: {
            circle: { cy: 0, opacity: 1 },
  ...
  initChangeAttributesEvents: function (crowd) {
    ...
    crowd.workspace.graph.on("change:type", function (element, newType) {
      ...
      if (element.isElement()) {
        ...
        element.markup = element.attributes.collapsed
          ? crowd.palette.elements[newType].attributes.collapsedMarkup
          : crowd.palette.elements[newType].markup;
    ...
    crowd.workspace.graph.on("change:uri", function (element, newUri) {
      ...
      if (element.isElement()) {
        ...
        $("#crowd-inspector-content--name--" + crowd.id).val(fromURI(newUri, crowd.config.defaultNamespace));
        element.trigger("change:name", element, element.prop("name"));
        if (element.attributes.parentType == "class")
    ...
    crowd.workspace.graph.on(
      "change:attributes",
      function (element, newAttributes, opt) {
    ...
    crowd.workspace.graph.on(
      "change:methods",
      function (element, newMethods, opt) {
    ...
    crowd.workspace.graph.on(
      "change:properties",
      function (element, newProperties, opt) {
        ...
        if (element.isElement() && element.attributes.parentType == "class") {
          ...
          element.prop(
            ...
            $.map(newProperties.attributes, function (attribute) {
              return joint.util.breakText(
                "- " +
                  (attribute.name
                    ? toInfixCaps(fromURI(attribute.name, crowd.config.defaultNamespace))
                    : "_") +
                  " : " +
                  (attribute.datatype ? attribute.datatype : "_"),
                { width: element.attributes.size.width + 25 }
              );
            })
          );
          ...
          element.prop(
            "methods",
            $.map(newProperties.methods, function (method) {
              return joint.util.breakText(
                "+ " + (method ? toInfixCaps(fromURI(method, crowd.config.defaultNamespace)) + "()" : "_"),
                { width: element.attributes.size.width + 25 }
              );
            })
          );
    ...
    crowd.workspace.graph.on(
      "change:collapsed",
      function (element, newCollapsed, opt) {
        // console.log('change:collapsed', { element, newCollapsed, opt });

        if (
          element.isElement() &&
          crowd.palette.elements[element.prop("type")].attributes
            .collapsedMarkup
        ) {
          ...
          var actualSize = element.size();
          var amountAttr =
            element.attributes?.attributes?.length +
            element.attributes?.methods?.length;
          var attrSize = 10;
          actualSize.height = newCollapsed
            ? parseInt(
                $(
                  elementView.el.getElementsByClassName("uml-class-name-rect")
                ).attr("height")
              )
          ...
          setTimeout(function () {
            ...
            if (!newCollapsed) classFitToContent(element);
          });
        }
      }
    );
    ...
    crowd.workspace.graph.on("change:type", function (link, newType) {
      ...
      if (link.isLink()) {
        ...
        link.prop(
          "parentType",
          crowd.palette.links[newType].attributes.parentType
        );
        ...
        else link.attributes.direction = null;
    ...
    crowd.workspace.graph.on(
      "change:cardinality change:roles change:uri change:showAssoc change:showRoles",
      function (link, newCardinalityRoleUri) {
          ...
          link.labels([
            ...
            },
            {
              attrs: {
                text: {
                  text:
                    link.attributes.showRoles && newRoles.source != "null"
                      ? fromURI(newRoles.source, crowd.config.defaultNamespace)
                      : null,
                },
              },
              position: {
            ...
            },
            {
              attrs: {
                text: {
                  text:
                    link.attributes.showRoles && newRoles.target != "null"
                      ? fromURI(newRoles.target, crowd.config.defaultNamespace)
                      : null,
                },
              },
              position: {
              ...
              ? [
                  {
                    attrs: {
                      text: {
                        text: link.attributes.showAssoc
    ...
    crowd.workspace.graph.on(
      ...
      function (link, newInheritChild) {
        ...
        if (link.isLink()) {
          if (newInheritChild) link.prop("direction", null);
          else link.prop("direction", "target");
          crowd.inspector.loadContent();
        }
      }
    );
    ...
    crowd.workspace.graph.on("change:subtype", function (element, newSubtype) {
      ...
      if (element.isElement() && element.prop("type") == "inheritance") {
        ...
        element.attr(
          "text/text",
          (element.prop("covering") ? "c," : "") + subtypesText[newSubtype]
        );
      }
    });
        ...
        if (cell.attributes.parentType == "class") {
          color = syntaxError
            ...
            : crowd.palette.elements[cell.attributes.type]?.attr(
                ".uml-class-name-rect/stroke"
              );
          strokeWidth = syntaxError
            ? strokeWidth
            : crowd.palette.elements[cell.attributes.type]?.attr(
                ".uml-class-name-rect/stroke-width"
              );
    ...
    crowd.workspace.graph.on("change:repairing", function (cell, newRepairing) {
      ...
      var forRemove = newRepairing?.contents?.find(function (content) {
        return content.value == "remove";
      });
      var forKeep = newRepairing?.contents?.find(function (content) {
        return content.value == "keep";
      });
      var forRestrict = newRepairing?.contents?.find(function (content) {
        return content.value == "restrict";
      });
      var color =
        forRemove != null
      ...
      if (cell.isElement()) {
        if (cell.attributes.parentType == "class") {
          color =
            forRemove != null || forKeep != null || forRestrict != null
              ? color
              : crowd.palette.elements[cell.attributes.type]?.attr(
                  ".uml-class-name-rect/stroke"
                );
    ...
    crowd.workspace.graph.on(
      "change:highlighted",
      function (cell, newHighlighted) {
        if (cell.isElement()) {
          if (cell.attributes.parentType == "class") {
            cell.attr(
              ".uml-class-name-rect/stroke",
              newHighlighted
                ? getCSS("color", "crowd-highlight-color")
                : crowd.palette.elements[cell.attributes.type]?.attr(
                    ".uml-class-name-rect/stroke"
                  )
            );
            cell.attr(
              ".uml-class-attrs-rect/stroke",
              newHighlighted
                ? getCSS("color", "crowd-highlight-color")
                : crowd.palette.elements[cell.attributes.type]?.attr(
                    ".uml-class-attrs-rect/stroke"
  ...
  initInspector: function (crowd) {
    ...
    switch (crowd.inspector.model.attributes.type) {
      ...
      case "interface":
        ...
        crowd.inspector.addAttribute({
          ...
          type: "list",
          default: {
            name: crowd.config.defaultNamespace + "#attribute",
            datatype: "string",
          },
          template: {
            type: "object",
        ...
        crowd.inspector.addAttribute({
          label: "Methods",
          property: "properties/methods",
          type: "list",
          default: crowd.config.defaultNamespace + "#method",
    ...
    if (
      crowd.inspector.model.attributes.repairing &&
      crowd.inspector.model.attributes.repairing.contents?.length
    )
      crowd.inspector.addAttribute({
        property: "repairing",
        type: "alert",
    ...
    crowd.workspace.graph.getCells().forEach(function (cell) {
      switch (cell.attributes.parentType) {
        ...
        case "composition":
          ...
          var connectedLinks = $.map(
            crowd.workspace.graph.getConnectedLinks(cell),
            (link) => {
          ...
          if (cell.ports?.roleSource != null)
            connectedLinks = [
              ...connectedLinks,
              ...$.map(
                crowd.workspace.graph.getConnectedLinks(cell.ports?.roleSource),
                (link) => {
          ...
          if (cell.ports?.roleTarget != null)
            connectedLinks = [
              ...connectedLinks,
              ...$.map(
                crowd.workspace.graph.getConnectedLinks(cell.ports?.roleTarget),
                (link) => {
          ...
          connectedLinks.forEach(function (link) {
            var connectedClass;
            if (
              link.link.attributes.direction &&
              link.link.attributes[link.link.attributes.direction].id !=
                link.cell.id
            ) {
              connectedClass =
                link.link.attributes.direction == "source"
                  ? link.link.getSourceCell()
                  : link.link.getTargetCell();
            } else if (
              !link.link.attributes.direction &&
              link.link.attributes.target.id != link.cell.id
            ) {
            ...
            if (
              ...
              jsonSchema.links.push({
                ...(linkTypeMap[link.link.attributes.type] != "generalization"
                  ? { uri: link.link.attributes.uri }
                  : {}),
                name: link.link.attributes.uri,
                ...(linkTypeMap[link.link.attributes.type] == "generalization"
                  ? { parent: connectedClass.attributes.uri }
                  : {}),
                classes: [
                  link.cell.attributes.uri,
                  ...(linkTypeMap[link.link.attributes.type] != "generalization"
                    ? [connectedClass.attributes.uri]
                    : []),
                ],
                ...
                ...(linkTypeMap[link.link.attributes.type] != "generalization"
                  ? {
                      multiplicity: [
                        link.link.attributes.direction &&
                        link.link.attributes.direction == "source"
                          ? link.link.attributes.cardinality.target
                          : link.link.attributes.cardinality.source,
                        link.link.attributes.direction &&
                        link.link.attributes.direction == "source"
                          ? link.link.attributes.cardinality.source
                          : link.link.attributes.cardinality.target,
                ...
                ...(linkTypeMap[link.link.attributes.type] != "generalization"
                  ? {
                      roles: [
                        link.link.attributes.direction &&
                        link.link.attributes.direction == "source"
                          ? link.link.attributes.roles.target
                            ? link.link.attributes.roles.target
                            : link.cell.attributes.uri
                          : link.link.attributes.roles.source
                          ? link.link.attributes.roles.source
                          : link.cell.attributes.uri,
                        link.link.attributes.direction &&
                        link.link.attributes.direction == "source"
        ...
        case "inheritance":
          ...
          if (cell.attributes.subtype == "disjoint")
            inheritanceLink.constraint.push("disjoint");
          if (cell.attributes.covering)
            inheritanceLink.constraint.push("covering");
          ...
          crowd.workspace.graph
            ...
            .forEach(function (link) {
              if (link.attributes.type == "generalization") {
                var connectedClass =
                  link.attributes.source.id != cell.id &&
                  (link.getSourceCell().attributes.parentType == "class" ||
                    link.getSourceCell().attributes.parentType ==
                      "association" ||
                    link.getSourceCell().attributes.parentType ==
                      "aggregation" ||
                    ...
                    : link.attributes.target.id != cell.id &&
                      (link.getTargetCell().attributes.parentType == "class" ||
                        link.getTargetCell().attributes.parentType ==
                          "association" ||
                        link.getTargetCell().attributes.parentType ==
                          "aggregation" ||
                        link.getTargetCell().attributes.parentType ==
      ...
      if (schema.links) {
        ...
        schema.links.forEach(function (link) {
          if (
            ...
            (link.classes.length <= 1 && link.constraint.length <= 0)
          ) {
            ...
            linksObj[parentLinkName] =
              crowd.palette.links.generalization.clone();
            ...
            link.classes.forEach(function (connectedClass, index) {
              var linkName =
                link.classes[index] + "-" + fromURI(inheritanceName, crowd.config.defaultNamespace);
          ...
          if (
            ...
            if (!link.position) {
              var mediumPosition = medianPoint(
                inheritancesObj[inheritanceName],
                link.classes
                  .map(function (connectedClass) {
                    return getObj(connectedClass);
                  })
                  .concat(getObj(link.parent))
              );
  ...
  initSyntaxValidator: function (crowd) {
    ...
    crowd.syntax.errors = {
      "class-disconnected": {
        value: "class-disconnected",
        text: "Class can not be disconnected of the diagram.",
      },
      "inheritance-disconnected": {
        value: "inheritance-disconnected",
        text: "Inheritance needs at least one parent class and child class connected.",
      },
      "inheritance-parent-exceed": {
        value: "inheritance-parent-exceed",
        text: "Inheritance can not have more than one parent class connected.",
      },
      "link-disconnected": {
        value: "link-disconnected",
        text: "Link needs to be connected both sides.",
      },
      "link-wrong-type-class": {
        value: "link-disconnected",
        text: "Link needs to connect two class elements.",
      },
      "link-wrong-type-inheritance": {
        value: "link-disconnected",
        text: "Link needs to connect: <ul><li>Two classes.</li><li>One class and one inheritance.</li><li>Two associations.</li></ul>",
      },
    };
    ...
    crowd.syntax.validateCell = function (cell) {
      ...
      if (cell.isElement()) {
        if (cell.attributes.parentType == "class") {
          if (
            crowd.workspace.graph.getConnectedLinks(cell).length <= 0 &&
            crowd.workspace.graph.getCells().length > 1
          )
          ...
          if (!inheritanceLinks) {
            ...
            if (
              !inheritanceLinks.some(function (link) {
                return (
                  (link.attributes.parentType == "generalization" ||
                    link.attributes.parentType == "implementation") &&
                  !link.attributes.inheritChild
                );
              }) ||
              !inheritanceLinks.some(function (link) {
                return (
              ...
              syntaxErrors.push(
                crowd.syntax.errors["inheritance-disconnected"]
              );
            } else if (
              ...
              syntaxErrors.push(
                crowd.syntax.errors["inheritance-parent-exceed"]
              );
            }
          }
        }
        ...
        if (!linkSource || !linkTarget) {
          ...
          if (
            cell.attributes.parentType == "association" ||
            cell.attributes.parentType == "aggregation" ||
            cell.attributes.parentType == "composition"
          ) {
            if (
              linkSource.attributes.parentType != "class" ||
              linkTarget.attributes.parentType != "class"
            ) {
              syntaxErrors.push(crowd.syntax.errors["link-wrong-type-class"]);
            }
          } else if (
            cell.attributes.parentType == "generalization" ||
            cell.attributes.parentType == "implementation"
          ) {
            if (
              !(
                linkSource.attributes.parentType == "class" &&
              ...
              !(
                linkSource.attributes.parentType == "class" &&
                linkTarget.attributes.parentType == "inheritance"
              ) &&
              !(
                linkTarget.attributes.parentType == "class" &&
                linkSource.attributes.parentType == "inheritance"
              ) &&
              !(
                linkTarget.attributes.parentType == "association" &&
                linkSource.attributes.parentType == "association"
              )
            ) {
              syntaxErrors.push(
                crowd.syntax.errors["link-wrong-type-inheritance"]
              );
            }
          }
        }
