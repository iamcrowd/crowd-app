...
A window will automatically open at [localhost:3335](http://localhost:3335). Angular and Express files are being watched. Any change automatically creates a new bundle, restart Express server and reload your browser.
